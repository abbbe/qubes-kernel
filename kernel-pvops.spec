# A spec file for building pvops Dom0 kernel for Qubes
...
%_sourcedir/apply-patches %_sourcedir/series-pvops.conf %_sourcedir $SYMBOLS
...
/sbin/dracut --nomdadmconf --nolvmconf \
    ...
    -d "xen-blkfront cdrom ext4 jbd2 crc16 dm_snapshot" \
